...
export function App() {
  ...
  // const [transactionApproval, setTransactionApproval] = useState<{[transactionId: string]: boolean}>({});
      ...
      <main className="MainContainer">
        ...
        <InputSelect<Employee>
          ...
          onChange={async (newValue) => {
            ...
            newValue===EMPTY_EMPLOYEE ? await employeeUtils.fetchAll() : await loadTransactionsByEmployee(newValue.id)
          }}
        />
